...
public class NoticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        galleryImagePicking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent imagePickingIntent = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
                startActivityForResult(imagePickingIntent,1);
            }
        });
    ...
    private void gotoDatabase() {
        ...
        NoticeData noticeData = new NoticeData(postTitle,"45 sem 3899","4a5:54 pm",uniqueId,"");
        database.child(uniqueId).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(NoticeActivity.this, "Text to be done", Toast.LENGTH_SHORT).show();
            }
        });
